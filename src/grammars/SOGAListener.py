...
class SOGAListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SOGAParser#matrix_gm_full.
    def enterMatrix_gm_full(self, ctx:SOGAParser.Matrix_gm_fullContext):
        pass

    # Exit a parse tree produced by SOGAParser#matrix_gm_full.
    def exitMatrix_gm_full(self, ctx:SOGAParser.Matrix_gm_fullContext):
        pass
